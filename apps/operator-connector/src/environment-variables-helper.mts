export class EnvironmentVariablesHelper {
    ...
    createEnvironmentVars(): EnvironmentVarsData {
        ...
        const result: EnvironmentVarsData = {
            CCS3_OPERATOR_CONNECTOR_NO_STATIC_FILES_SERVING: {},
        ...
        result.CCS3_OPERATOR_CONNECTOR_STATIC_FILES_PATH.value = this.getEnvVarValue(result.CCS3_OPERATOR_CONNECTOR_STATIC_FILES_PATH.name, './web-app');
...
export interface EnvironmentVarsData {
    ...
    CCS3_OPERATOR_CONNECTOR_CERTIFICATE_CRT_FILE_PATH: EnvironmentVariableNameWithValue<string | undefined>;
    CCS3_OPERATOR_CONNECTOR_CERTIFICATE_KEY_FILE_PATH: EnvironmentVariableNameWithValue<string | undefined>;
}
