...
export const OperatorReplyMessageErrorCode = {
    ...
    tariffIsInUse: 'tariff-is-in-use',
} as const;
export type OperatorReplyMessageErrorCode = ValueOf<typeof OperatorReplyMessageErrorCode>;
